 ...
 * @author ffos
 */
@WebServlet(name = "While_02", urlPatterns = {"/while_02"})
public class While_02 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet While_02</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Operação: " + operacao + "</h1>");
